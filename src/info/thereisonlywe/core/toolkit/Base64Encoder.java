...
public class Base64Encoder
{
	...
	public static String decodeString(String s, String charset)
	{
		try
		{
			if (charset != null) return new String(decode(s), charset);
			else return new String(decode(s));
		}
	...
	public static String encodeString(String s, String charset)
	{
		try
		{
			if (charset != null) return new String(encode(s.getBytes(charset)));
			else return new String(encode(s.getBytes()));
		}
		catch (UnsupportedEncodingException e)
		{
			return new String(encode(s.getBytes()));
