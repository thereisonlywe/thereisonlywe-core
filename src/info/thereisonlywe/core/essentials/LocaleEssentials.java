 ...
 */
public class LocaleEssentials
{
	public static final Locale LOCALE_DEFAULT = Locale.getDefault();
	public static final String LANGUAGE_DEFAULT = new String(LOCALE_DEFAULT
	...
	public static final String[] countryCodes = { "--", "AP", "EU", "AD", "AE",
		...
		"EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "FX", "GA",
		...
		"TG", "TH", "TJ", "TK", "TM", "TN", "TO", "TL", "TR", "TT", "TV", "TW",
		"TZ", "UA", "UG", "UM", "US", "UY", "UZ", "VA", "VC", "VE", "VG", "VI",
		"VN", "VU", "WF", "WS", "YE", "YT", "RS", "ZA", "ZM", "ME", "ZW", "A1",
		"A2", "O1", "AX", "GG", "IM", "JE", "BL", "MF" };
	public static final String[] countryNames = { "N/A", "Asia/Pacific Region",
	...
	public static String getCountryCode(String countryName)
	{
		...
		// if (locales[i].getDisplayCountry().toLowerCase().equals(
		// countryName.toLowerCase()))
		// return locales[i].getCountry();
		// }
		// return null;
		for (int i = 0; i < LocaleEssentials.countryCodes.length; i++)
		{
			if (LocaleEssentials.countryNames[i].toLowerCase().contains(
				countryName.toLowerCase())) return countryCodes[i];
		}
		return null;
	}
	...
	public static String getCountryName(String countryCode)
	{
		// Locale[] locales = Locale.getAvailableLocales();
		// for (int i =0; i<locales.length; i++){
		// if (locales[i].getCountry().toLowerCase().equals(
		// countryCode.toLowerCase()))
		// return locales[i].getDisplayCountry();
		// }
		// return null;
		for (int i = 0; i < LocaleEssentials.countryCodes.length; i++)
		{
			if (LocaleEssentials.countryCodes[i].toLowerCase().contains(
				countryCode.toLowerCase())) return LocaleEssentials.countryNames[i];
		}
		return null;
	}
}
